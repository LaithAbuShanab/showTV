    ...
    <section class="section details">
        ...
        <div class="container">
            <div class="row">
                ...
                <!-- player -->
                @php
                    $videoUrl = $firstEpisode?->getFirstMediaUrl('episode_video', 'video');
                @endphp

                @if ($videoUrl)
                    <div class="col-12 col-xl-6">
                        <video controls crossorigin playsinline
                            poster="{{ $firstEpisode->getFirstMediaUrl('episode_cover', 'thumbnail') }}" id="player">
                                ...
                                @if ($season->episodes->count() > 0)
                                    ...
                                    <div class="accordion__card">
                                        <div class="card-header" id="{{ $headingId }}">
                                            <button type="button" class="{{ $isFirst ? '' : 'collapsed' }}"
                                                ...
                                                <table class="accordion__list">
                                                    ...
                                                    <tbody>
                                                        @foreach ($season->episodes as $epIndex => $episode)
                                                            <tr class="{{ request()->routeIs('episode.show') && request()->route('episode')->id == $episode->id ? 'active' : ($isFirst && $epIndex === 0 ? 'active' : '') }}"
                                                                onclick="window.location='{{ route('episode.index', $episode) }}'">
                                                                <th>
